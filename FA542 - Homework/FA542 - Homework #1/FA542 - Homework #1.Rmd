...
CAT_lower_bound <- CAT_mean - abs(t_score) * (CAT_sd / sqrt(n))
CAT_upper_bound <- CAT_mean + abs(t_score) * (CAT_sd / sqrt(n))
...
```{r}
t_skewness <- skewness(CAT_log_returns) / sqrt(6 / length(CAT_log_returns))
