...
For $r_1$, the sample mean ($-0.05821449$) is slightly lower than the analytical mean ($-0.04724409$), and for $r_2$, the sample mean ($0.11096290$) is also lower compared to the analytical mean ($0.14960630$).
